...
variable "vpc_cross_peer_region" {
  default = "ap-south-1"
}
...
variable "vpc_cross_peer_cidr" {
  default = "10.3.0.0/16"
}

variable "subnet_cidr" {
  type = "list"
  default = ["10.1.0.0/24","10.1.1.0/24","10.1.2.0/24","10.2.0.0/24","10.2.1.0/24","10.3.0.0/24","10.3.1.0/24"]
}

variable "private_ip" {
  type = "list"
  default = ["10.1.0.25","10.1.1.30","10.2.0.25","10.2.1.30","10.3.0.25","10.3.1.30"]
}
...
data "aws_availability_zones" "azs-3" {
  provider = "aws.cross"
}
